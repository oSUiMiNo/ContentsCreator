...
namespace NobleConnect.Mirror
{
    public class NobleNetworkManager : NetworkManager
    {
        ...
        /// </remarks>
        virtual public void InitClient()
        {
        ...
        /// </remarks>
        new virtual public void StartClient()
        {
            isLANOnly = false;
            isNoble = true;
        ...
        virtual public void StartClient(IPEndPoint hostEndPoint)
        {
            isLANOnly = false;
            isNoble = true;
        ...
        /// </remarks>
        virtual public void StartClientLANOnly()
        {
        ...
        virtual public void StartClientLANOnly(IPEndPoint hostEndPoint)
        {
            isLANOnly = true;
        ...
        new virtual public void StartHost()
        {
            ...
            MirrorHelper.TransportPort = (ushort)networkPort;
        ...
        /// </returns>
        virtual public void StartHostLANOnly()
        {
            isLANOnly = true;
            base.StartHost();
        }
        ...
        /// is ready to receive relay / punchthrough connections.
        /// </remarks>
        new virtual public void StartServer()
        {
            isLANOnly = false;
            isNoble = true;
        ...
        /// OnServerPrepared will be called immediately and passed the local LAN address that clients can use to connect.
        /// </remarks>
        virtual public void StartServerLANonly()
        {
            isLANOnly = true;
            base.StartServer();
        }
        ...
        /// </remarks>
        new virtual public void StopClient()
        {
            base.StopClient();
            if (client != null)
            {
        ...
        virtual public void RegisterClientHandlers()
        {
        ...
        override public void OnStartServer()
        {
            ...
            if (!isLANOnly)
            {
                try
                {
                    ...
                    IPEndPoint localEndPoint = MirrorHelper.LocalTransportEndPoint;
                    NobleServer.InitializeHosting(localEndPoint, region, OnServerPrepared, OnFatalError, forceRelayConnection);
                }
                catch (SocketException)
                {
                    isLANOnly = true;
        ...
        public void OnStartServerLANOnly()
        {
            ...
            networkPort = MirrorHelper.TransportPort;
